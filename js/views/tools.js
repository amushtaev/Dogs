...
$("#content").load("http://adesign.dp.ua/load_00.html", function (response, status, xhr) {
  // error handling
  if (status == "error") {
...
$('div[id^="next_"]').on("click", function(){
...
.on("click", function(){
  ...
  $(this).addClass('placeholder-class');
})
.stop();
$('.input-group.date')
.on("click", function(){
...
.stop();
$('.input-group-addon:not(".calendar")')
.on("click", function(){
  $(this).hide();
  $(this).next('.form-control').removeClass('red-border');
  $(this).next('.form-control').addClass('placeholder-class');
})
.stop();
...
.stop();
//uncomment if need call Function
/*function Visible() {
